...
export default class RFB extends EventTargetMixin {
    ...
    _socketClose(e) {
        console.log("[RFB] _socketClose event:", e);
    ...
    _handleMouse(ev) {
         ...
         */
        console.log('[RFB] _handleMouse:', ev.type, 'connectionState:', this._rfbConnectionState);
    ...
    _sendMouse(x, y, mask) {
        console.log('[RFB] _sendMouse:', x, y, mask, 'connectionState:', this._rfbConnectionState);
        ...
        try {
            ...
            console.error('[RFB] Error in pointerEvent:', e);
        }
    }
    ...
    _sendEncodings() {
        ...
        // In preference order - only use uncompressed encodings
